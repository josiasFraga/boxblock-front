...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 mt-12">
        ...
        <div className="grid grid-cols-2 gap-8 py-8 px-6  container flex flex-col mx-auto px-2">
            <div>
                <ul className="text-gray-300 dark:text-gray-300">
                    <li className="mb-4">
            ...
            <div>
                <ul className="text-gray-300 dark:text-gray-300">
                    ...
                    <li className="mb-4">
                        <a href="#" className="hover:underline">Guia da Comunidade</a>
                    </li>
                    <li className="mb-4">
        ...
        <div className="py-6 px-4 items-center flex-row  justify-between container flex mx-auto px-2 place-content-center">
            <span className="text-sm text-gray-300 dark:text-gray-300 sm:text-center">© 2022 Gurumê Colecionáveis
            </span>
