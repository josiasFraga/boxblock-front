...
import gurumeLogo from '../assets/images/gurume_logo.png'
  ...
  return (
    <nav className="border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 mt-4">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <Link href="/">
          <Image src={gurumeLogo} height={50} width={120} />
        </Link>
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="flex flex-col p-4 mt-4  rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 font-sora">
            ...
            <li>
              <Link href="/perfil" className="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">
                Perfil
              </Link>
            </li>
            <li>
              <Link href="/sair" className="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">
                Sair
              </Link>
            </li>
        ...
        {!address && router.pathname == "/colecoes/criar" &&
